...
export class NotificationRequestBuilder {
    ...
    public addChannel(channel: string): this {
        if (channel && channel.trim() !== '') {
            this._channels.push(channel.toUpperCase());
        }
        return this;
    }

    public toEmail(email: string): this {
        this._to['email'] = email;
        return this;
    }

    public toPhone(phone: string): this {
        this._to['phone'] = phone;
        return this;
    }

    public toWebhook(url: string): this {
        this._to['url'] = url;
        return this;
    }

    public templateId(templateId: string): this {
    ...
    public scheduleFor(date: Date): this {
    ...
    public build(): NotificationRequest {
        ...
        // Utilizing a cast to bypass private constructor access locally
